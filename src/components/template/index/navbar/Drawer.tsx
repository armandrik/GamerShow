  ...
  return (
    <>
      <button
        ...
        className="text-white cursor-pointer hover:text-primary transition-all"
      >
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="size-12 hidden tablet:block mobile:size-11"
        >
          <path
            strokeLinecap="round"
      ...
      >
        <button
          ...
          aria-controls="drawer-example"
          onClick={closeDrawer}
          className="text-gray-400 bg-transparent hover:bg-primary/50 hover:text-white rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center"
        >
          <svg
            className="w-3 h-3"
            aria-hidden="true"
        ...
        <div className="h-[95%] flex flex-col justify-between">
          <ul className="text-white text-lg font-medium [&>li]:cursor-pointer mt-5 [&>li]:flex [&>li]:items-center [&>li]:justify-start [&>li]:gap-2 [&>li]:bg-main [&>li]:my-5 [&>li]:rounded-xl [&>li]:pr-3 mobile:text-base">
            ...
            <li>
              ...
              <Link href="/product" className="w-[80%] py-3">
                فروشگاه
              </Link>
            </li>
            <li>
              ...
              <Link href="/contact-us" className="w-[80%] py-3">
                تماس با‌ما
              </Link>
            </li>
            <li>
              ...
              <Link href="/blogs" className="w-[80%] py-3">
                وبلاگ
              </Link>
            </li>
          </ul>
