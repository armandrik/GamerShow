...
function Product({ params }: productPropType) {
  return (
    <div>
      ...
      <SimilarGames />
      <div className="my-20 pt-10 bg-no-repeat bg-top bg-[linear-gradient(to_top,rgba(31,33,40,1),rgba(33,31,40,0.9)),url('https://media.rawg.io/media/games/4be/4be6a6ad0364751a96229c56bf69be59.jpg')]">
        <Comments />
      </div>
      <Footer />
    </div>
